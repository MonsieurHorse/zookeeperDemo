package com.common.zookeeper.lock;
...
public class LeaderElection extends TestMainClient {
    ...
    void findLeader() throws InterruptedException, UnknownHostException, KeeperException, UnsupportedEncodingException {
        byte[] leader = null;
        try {
            leader = zk.getData(root + "/leader", true, null);
            System.out.println("leader: " + new String(leader, "utf-8"));
        } catch (KeeperException e) {
    ...
    public static void main(String[] args) {
        String connectString = "10.10.3.13:2181";
