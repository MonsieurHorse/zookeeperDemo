...
//        if ( !ObjectUtil.isBlank( this.zk ) ) {
        if (!com.sun.deploy.util.StringUtils.trimWhitespace(String.valueOf(this.zk)).equals("") && this.zk != null) {
//            String.valueOf(this.zk).trim().equals("");
//            StringUtils.isEmpty(this.zk);
            try {
                this.zk.close();
            } catch ( InterruptedException e ) {
                // ignore
