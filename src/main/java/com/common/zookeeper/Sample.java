...
public class Sample {
    ...
    // 根节点
    public static final String ROOT = "/root-ktv2";
    ...
    public static void main(String[] args) throws Exception {
        ...
        zk.create(ROOT, "root-ktv2".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
...
//        zk.create(ROOT+"/shenzhengKTV", "深圳KTV".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
